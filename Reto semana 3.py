...
def consultaRegistro(ventas, idProducto):
    ...
    if len(resultado2)==0:
        ...
        for i in resultado2:
            resultado3+= 'Producto consultado : {}  Descripción  {}  #Parte  {}  Cantidad vendida  {}  Stock  {}  Comprador {}  Documento  {}  Fecha Venta  {}'.format(ventas[i][0][0],ventas[i][0][1], ventas[i][0][2], ventas[i][0][3], ventas [i][0][4], ventas [i][0][5], ventas [i][0][6], ventas [i][0][7]) 
            resultado3+= '\n'
